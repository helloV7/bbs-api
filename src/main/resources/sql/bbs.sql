...
INSERT INTO `area` VALUES (1,'','娱乐闲聊','','','2018-10-16'),(2,'','教学课程','','','2018-10-16'),(3,'','技术交流','','','2018-10-16');
...
CREATE TABLE `message` (
  ...
  `type` varchar(255) DEFAULT NULL COMMENT '0、禁言。1、解禁言。2、购买。3、举报别人帖子的处理。4、自己的帖子或者楼层被删除的消息。5、私信',
  `create_time` date DEFAULT NULL,
  PRIMARY KEY (`id`)
